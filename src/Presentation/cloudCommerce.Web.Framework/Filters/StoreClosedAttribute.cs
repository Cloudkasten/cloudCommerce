...
namespace cloudCommerce.Web.Framework.Filters
{
    public class StoreClosedAttribute : ActionFilterAttribute
    {
		private static readonly List<Tuple<string, string>> s_permittedRoutes = new List<Tuple<string, string>> 
		{
			...
			new Tuple<string, string>("cloudCommerce.Web.Controllers.HomeController", "StoreClosed"),
			new Tuple<string, string>("cloudCommerce.Web.Controllers.CommonController", "SetLanguage")
		};
