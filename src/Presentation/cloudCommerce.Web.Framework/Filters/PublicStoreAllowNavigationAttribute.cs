...
namespace cloudCommerce.Web.Framework.Filters
{
    public class PublicStoreAllowNavigationAttribute : ActionFilterAttribute
    {
		...
		{
 			new Tuple<string, string>("cloudCommerce.Web.Controllers.CustomerController", "Login"),
			new Tuple<string, string>("cloudCommerce.Web.Controllers.CustomerController", "Logout"),
			new Tuple<string, string>("cloudCommerce.Web.Controllers.CustomerController", "Register"),
			new Tuple<string, string>("cloudCommerce.Web.Controllers.CustomerController", "PasswordRecovery"),
			new Tuple<string, string>("cloudCommerce.Web.Controllers.CustomerController", "PasswordRecoveryConfirm"),
			new Tuple<string, string>("cloudCommerce.Web.Controllers.CustomerController", "AccountActivation"),
			new Tuple<string, string>("cloudCommerce.Web.Controllers.CustomerController", "CheckUsernameAvailability")
		};
