...
using cloudCommerce.Web.Framework.UI.Captcha;
using cloudCommerce.Web.Infrastructure.Cache;
...
namespace cloudCommerce.Web.Controllers
{
	public class CatalogHelper
	{
		...
		{
			var requestCache = cloudCommerce.Core.Infrastructure.EngineContext.Current.Resolve<ICacheManager>();
			...
			if (model.AllowProductSorting)
			{
				...
				foreach (ProductSortingEnum enumValue in Enum.GetValues(typeof(ProductSortingEnum)))
				{
                    if (enumValue == ProductSortingEnum.CreatedOnAsc || enumValue == ProductSortingEnum.Initial)
					{
						...
						// Ist eigentlich kein Problem, ABER: Wir müssten immer wenn cloudCommerce
