...
using cloudCommerce.Web.Models.Order;
...
namespace cloudCommerce.Web.Controllers
{
    public partial class OrderController : PublicControllerBase
    {
		...
		protected OrderDetailsModel PrepareOrderDetailsModel(Order order)
        {
            ...
            if (paymentMethod != null && paymentMethod.Metadata.SystemName.Equals("cloudCommerce.PurchaseOrderNumber", StringComparison.InvariantCultureIgnoreCase))
            {
