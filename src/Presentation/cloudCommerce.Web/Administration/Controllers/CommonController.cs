...
namespace cloudCommerce.Admin.Controllers
{
    ...
    public class CommonController : AdminControllerBase
    {
		...
		{
			var curVersion = cloudCommerceVersion.CurrentFullVersion;
			...
			var result = await _services.Cache.Get(cacheKey, async () =>
			{
				...
				try
				{
					...
					using (var client = new HttpClient())
					{
						...
						client.DefaultRequestHeaders.UserAgent.ParseAdd("cloudCommerce.NET {0}".FormatInvariant(curVersion));
        ...
        public ActionResult SystemInfo()
        {
            ...
            model.AppVersion = cloudCommerceVersion.CurrentFullVersion;
