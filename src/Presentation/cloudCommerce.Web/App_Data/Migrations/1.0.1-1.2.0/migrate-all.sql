...
<Language>
  ...
  <LocaleResource Name="Admin.Configuration.Stores.Fields.DisplayOrder.Hint">
	...
	<Value lang="de">Die Reihenfolge f�r diesen Shop. 1 bedeutet Anfang der Liste.</Value>
  </LocaleResource>
  <LocaleResource Name="Admin.Configuration.Stores.Added">
	<Value>The new store has been added successfully.</Value>
	<Value lang="de">Der neue Shop wurde erfolgreich hinzugef�gt.</Value>
  </LocaleResource>
  ...
  <LocaleResource Name="Admin.Configuration.Stores.Deleted">
	...
	<Value lang="de">Der Shop wurde erfolgreich gel�scht.</Value>
  </LocaleResource>
  ...
  <LocaleResource Name="Admin.Orders.Fields.Store.Hint">
	...
	<Value lang="de">Name des Shops f�r diese Bestellung.</Value>
  </LocaleResource>
  ...
  <LocaleResource Name="Admin.Configuration.Stores.Fields.Hosts.Hint">
	...
	<Value lang="de">Kommagetrennte Liste mit m�glichen HTTP_POTS Werten (z.B. "mein-shop.com,www.mein-shop.de"). Diese Einstellung wird nur in einer Multi-Shop Umgebung ben�tigt, um den aktuellen Shop zu ermitteln.</Value>
  </LocaleResource>
  ...
  <LocaleResource Name="Admin.System.SystemInfo.HTTPHOST.Hint">
	...
	<Value lang="de">HTTP_HOST wird in einer Multi-Shop Umgebung ben�tigt, um den aktuellen Shop zu ermitteln.</Value>
  </LocaleResource>
  ...
  <LocaleResource Name="Admin.ContentManagement.MessageTemplates.Deleted">
	...
	<Value lang="de">Die Nachrichtenvorlage wurde erfolgreich gel�scht.</Value>
  </LocaleResource>
  ...
  <LocaleResource Name="Plugins.Feed.Froogle.Store.Hint">
	...
	<Value lang="de">W�hlen Sie den Shop, f�r den der Feed erstellt werden soll.</Value>
  </LocaleResource>
  ...
  <LocaleResource Name="Admin.Configuration.Settings.StoreScope">
	...
	<Value lang="de">Multi-Shop Konfiguration f�r</Value>
  </LocaleResource>
  ...
  <LocaleResource Name="Admin.Configuration.Settings.StoreScope.CheckAll.Hint">
	...
	<Value lang="de">An- bzw. ausschalten, falls Sie f�r diesen Shop separate Werte festlegen m�chten</Value>
  </LocaleResource>
  ...
  <LocaleResource Name="Admin.Configuration.Settings.GeneralCommon.CaptchaEnabledNoKeys">
	...
	<Value lang="de">Captcha wurde aktiviert, aber die zugeh�rigen Schl�ssel fehlen.</Value>
  </LocaleResource>
  ...
  <LocaleResource Name="Plugins.Shipping.ByWeight.Fields.Store.Hint">
    ...
    <Value lang="de">Wird das Sternchen ausgew�hlt, so wird die Rate auf alle Shops angewandt.</Value>
  </LocaleResource>
  
  <LocaleResource Name="Plugins.Payment.CashOnDelivery.AdditionalFeePercentage">
    <Value>Additional fee. Use percentage</Value>
    <Value lang="de">Zus�tzliche Geb�hren (prozentual)</Value>
  </LocaleResource>
  <LocaleResource Name="Plugins.Payment.CashOnDelivery.AdditionalFeePercentage.Hint">
    ...
    <Value lang="de">Zus�tzliche prozentuale Geb�hr zum Gesamtbetrag. Es wird ein fester Wert verwendet, falls diese Option nicht aktiviert ist.</Value>
  </LocaleResource>
  ...
  <LocaleResource Name="Admin.Configuration.Settings.ShoppingCart.ShowConfirmOrderLegalHint">
	...
	<Value lang="de">Rechtliche Hinweise in der Warenkorb�bersicht auf der Bestellabschlu�seite anzeigen</Value>
  </LocaleResource>
  <LocaleResource Name="Admin.Configuration.Settings.ShoppingCart.ShowConfirmOrderLegalHint.Hint">
	...
	<Value lang="de">Bestimmt, ob rechtliche Hinweise in der Warenkorb�bersicht auf der Bestellabschlu�seite angezeigt werden. Dieser Text kann in den Sprachresourcen ge�ndert werden.</Value>
  </LocaleResource>
  ...
  <LocaleResource Name="OrderSummary.ConfirmOrderLegalHint">
	...
	<Value lang="de">Bei Lieferungen in das Nicht-EU-Ausland k�nnen zus�tzlich Z�lle, Steuern und Geb�hren anfallen.</Value>
  </LocaleResource>
  ...
  <LocaleResource Name="Common.Error.SendMail">
	...
	<Value lang="de">Fehler beim Versenden der Email. Bitte versuchen Sie es sp�ter erneut.</Value>
  </LocaleResource>
  ...
  <LocaleResource Name="Account.Fields.FullName.Required">
	...
	<Value lang="de">Name wird ben�tigt</Value>
  </LocaleResource>
  ...
  <LocaleResource Name="Admin.Configuration.Settings.Catalog.AskQuestionEnabled">
	...
	<Value lang="de">''Produktanfragen'' erm�glichen</Value>
  </LocaleResource>
  ...
  <LocaleResource Name="Admin.Configuration.Settings.Catalog.AskQuestionEnabled.Hint">
	...
	<Value lang="de">Legt fest, ob Kunden eine Anfrage zu einem Produkt stellen k�nnen</Value>
  </LocaleResource>
  ...
  <LocaleResource Name="Admin.Configuration.Settings.Catalog.DefaultViewMode.Hint">
	...
	<Value lang="de">Legt fest, wie Produktlisten standardm��ig dargestellt werden sollen. Der Kunde kann die Darstellung im Shop �ndern.</Value>
  </LocaleResource>
  ...
  <LocaleResource Name="Admin.Configuration.Plugins.Resources.UpdateConfirm">
	...
	<Value lang="de">M�chten Sie die Sprachressourcen f�r dieses Plugin aktualisieren?</Value>
  </LocaleResource>
  ...
  <LocaleResource Name="Admin.Common.Store.LimitedTo.Hint">
	...
	<Value lang="de">Legt fest, ob der Eintrag nur f�r bestimmte Shops verf�gbar ist.</Value>
  </LocaleResource>
  ...
  <LocaleResource Name="Admin.Common.Store.AvailableFor.Hint">
	...
	<Value lang="de">Bitte Shops ausw�hlen, f�r die der Eintrag angezeigt werden soll.</Value>
  </LocaleResource>
  ...
  <LocaleResource Name="Plugins.Shipping.ByTotal.Fields.BaseCharge">
	...
	<Value lang="de">Basisgeb�hr</Value>
  </LocaleResource>
  <LocaleResource Name="Plugins.Shipping.ByTotal.Fields.MaxCharge">
    <Value>Max. fee</Value>
	<Value lang="de">Max. Geb�hr</Value>
  </LocaleResource>
  <LocaleResource Name="Plugins.Shipping.ByTotal.Fields.MaxCharge.Hint">
	...
	<Value lang="de">Ein Betrag, den die berechneten Versandkosten nicht �bersteigen d�rfen.</Value>
  </LocaleResource>   
  ...
  <LocaleResource Name="ErrorPage.Body">
	...
	<Value lang="de">Unser Support-Team wurde �ber diesen Fehler informiert und wird sich in K�rze um die Behebung k�mmern. Wir entschuldigen uns f�r diese Unannehmlichkeit! Bitte probieren Sie den Vorgang zu einem sp�teren Zeitpunkt erneut.</Value>
  </LocaleResource>
  
  <LocaleResource Name="AddProductToCompareList.CouldNotBeAdded">
    <Value>Product could not be added.</Value>
	<Value lang="de">Produkt konnte nicht hinzugef�gt werden.</Value>
  </LocaleResource>
  <LocaleResource Name="AddProductToCompareList.ProductWasAdded">
    <Value>The product ''{0}'' was added to the compare list.</Value>
	<Value lang="de">Das Produkt ''{0}'' wurde der Vergleichsliste hinzugef�gt.</Value>
  </LocaleResource>
  ...
  <LocaleResource Name="Jquery.Validate.Email">
	...
	<Value lang="de">Bitte geben Sie eine g�ltige E-Mail-Adresse ein.</Value>
  </LocaleResource>
 ...
 <LocaleResource Name="Jquery.Validate.Number">
  ...
  <LocaleResource Name="Jquery.Validate.Creditcard">
	...
	<Value lang="de">Bitte geben Sie eine g�ltige Kreditkartennummer ein.</Value>
  </LocaleResource>
  ...
  <LocaleResource Name="Jquery.Validate.Rangelength">
	...
	<Value lang="de">Die L�nge der Eingabe darf minimal {0} und maximal {1} Zeichen lang sein.</Value>
  </LocaleResource>
  ...
  <LocaleResource Name="Jquery.Validate.Min">
	...
	<Value lang="de">Bitte geben Sie einen Wert gr��er oder gleich {0} ein.</Value>
  </LocaleResource>
  ...
  <LocaleResource Name="Admin.ContentManagement.Topics.Fields.WidgetZone.Hint">
	...
	<Value lang="de">Ein oder mehrere Widget Zonen, in denen der Content dargestellt werden soll. Hinweis: ein Theme definiert deutlich mehr Zonen als hier angeboten. Suchen Sie die View-Dateien nach "@Html.Widget(...)" ab, um alle verf�gbaren Zonen-Namen zu ermitteln.</Value>
  </LocaleResource>
  ...
  <LocaleResource Name="Admin.ContentManagement.Topics.Fields.WidgetShowTitle.Hint">
	...
	<Value lang="de">Legt fest, ob der Titel als �berschrift dargestellt werden soll.</Value>
  </LocaleResource>
  ...
  <LocaleResource Name="Admin.Orders.List.OrderNumber.Hint">
	...
	<Value lang="de">Suche �ber die Auftragsnummer oder Teile davon. Freilassen, um alle Auftr�ge zu laden.</Value>
  </LocaleResource>
  ...
  <LocaleResource Name="Admin.Configuration.Settings.GeneralCommon.InvalidLanguageRedirectBehaviour">
	...
	<Value lang="de">Verhalten bei ung�ltiger Sprache</Value>
  </LocaleResource>
  <LocaleResource Name="Admin.Configuration.Settings.GeneralCommon.InvalidLanguageRedirectBehaviour.Hint">
	...
	<Value lang="de">Legt das Redirect-Verhalten fest, wenn eine Seite mit einem ung�ltigen bzw. inaktiven SEO code (Sprachk�rzel) angefordert wird.</Value>
  </LocaleResource>

  <LocaleResource Name="Enums.cloudCommerce.Core.Domain.Localization.DefaultLanguageRedirectBehaviour.PrependSeoCodeAndRedirect">
    <Value>Prepend SEO code to url and redirect</Value>
	<Value lang="de">Der URL SEO Code voranstellen und weiterleiten</Value>
  </LocaleResource>
  <LocaleResource Name="Enums.cloudCommerce.Core.Domain.Localization.DefaultLanguageRedirectBehaviour.DoNoRedirect">
    <Value>Do not redirect</Value>
	<Value lang="de">Nicht weiterleiten</Value>
  </LocaleResource>
  <LocaleResource Name="Enums.cloudCommerce.Core.Domain.Localization.DefaultLanguageRedirectBehaviour.StripSeoCode">
    <Value>Strip SEO code if specified (recommended)</Value>
	<Value lang="de">SEO Code entfernen wenn angegeben (empfohlen)</Value>
  </LocaleResource>
  <LocaleResource Name="Enums.cloudCommerce.Core.Domain.Localization.InvalidLanguageRedirectBehaviour.Tolerate">
    <Value>Tolerate</Value>
	<Value lang="de">Tolerieren</Value>
  </LocaleResource>
  <LocaleResource Name="Enums.cloudCommerce.Core.Domain.Localization.InvalidLanguageRedirectBehaviour.FallbackToWorkingLanguage">
    <Value>Fallback to working language</Value>
	<Value lang="de">Zur aktiven Sprache bzw. Standardsprache umleiten</Value>
  </LocaleResource>
  <LocaleResource Name="Enums.cloudCommerce.Core.Domain.Localization.InvalidLanguageRedirectBehaviour.ReturnHttp404">
    <Value>Return HTTP 404 (page not found) (recommended)</Value>
	<Value lang="de">HTTP 404 zur�ckgeben (Seite nicht gefunden) (empfohlen)</Value>
  </LocaleResource>
...
BEGIN
	UPDATE [MessageTemplate] SET [Body] = '<style type="text/css">address, blockquote, center, del, dir, div, dl, fieldset, form, h1, h2, h3, h4, h5, h6, hr, ins, isindex, menu, noframes, noscript, ol, p, pre, table{ margin:0px; } body, td, p{ font-size: 13px;font-family: ''Segoe UI'', Tahoma, Arial, Helvetica, sans-serif; line-height: 18px; color: #163764; } body{ background:#efefef; } p{ margin-top: 0px; margin-bottom: 10px; } img{ border:0px; } th{ font-weight:bold; color: #ffffff; padding: 5px 0 5px 0; } ul{ list-style-type: square; } li{ line-height: normal; margin-bottom: 5px; } .template-body { width:720px; padding: 10px; border: 1px solid #ccc; } .attr-caption { font-weight: bold; text-align:right; } .attr-value { text-align:right; min-width:158px; width:160px; } .legal-infos, .legal-infos p { font-size:11px; color: #aaa} .supplier-identification, .supplier-identification td { color: #646464; font-size: 11px } .supplier-identification { width:100%;border-top: 1px solid #ccc; border-bottom: 1px solid #ccc }</style><center><table border="0" cellpadding="0" cellspacing="0" align="center" bgcolor="#ffffff" class="template-body"><tbody><tr><td><p><a href="%NewsLetterSubscription.ActivationUrl%">Klicken Sie hier, um Ihre Newsletter-Registrierung zu best�tigen.</a></p> <p>Sollten Sie diese E-Mail f&auml;lschlich erhalten haben, l&ouml;schen Sie bitte diese E-Mail.</p> <p></p> <p>Ihr&nbsp;%Store.Name% - Team</p></td></tr></tbody></table></center>'
