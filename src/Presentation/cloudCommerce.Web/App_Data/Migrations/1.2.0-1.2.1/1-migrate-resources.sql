...
<Language>
	...
	<LocaleResource Name="Fields.LimitToCurrentBasketSubTotal.Hint">
		...
		<Value lang="de">Legt fest, ob sich der angegebene Betrag auf die Zwischensumme im aktuellen Warenkorb oder - wenn inaktiv - auf die Summe aller zuvor vom Kunden get�tigten Bestellungen bezieht.</Value>
	</LocaleResource>
	<LocaleResource Name="Fields.BasketSubTotalIncludesDiscounts">
		<Value>Include discounts</Value>
		<Value lang="de">Positions-Rabatte ber�cktichtigen</Value>
	</LocaleResource>
	<LocaleResource Name="Fields.BasketSubTotalIncludesDiscounts.Hint">
		...
		<Value lang="de">Wenn aktiv, ist der Vergleichswert die Warenkorbsumme abz�glich aller Positions-Rabatte.</Value>
	</LocaleResource>
	
	<LocaleResource Name="Admin.System.SystemInfo.DatabaseSize">
		<Value>Size of database</Value>
		<Value lang="de">Gr��e der Datenbank</Value>
	</LocaleResource>
	...
	<LocaleResource Name="Admin.Configuration.Stores.Fields.HtmlBodyId.Hint">
		...
		<Value lang="de">Em�glicht es, individuelles CSS und Javascript f�r einen Shop zu verwenden.</Value>
	</LocaleResource>
	...
	<LocaleResource Name="Admin.Configuration.Plugins.ExecuteTasks">
		...
		<Value lang="de">Aufgaben ausf�hren</Value>
	</LocaleResource>
	<LocaleResource Name="Admin.Configuration.Plugins.ExecuteTasks.Confirm">
		...
		<Value lang="de">M�chten Sie die anstehenden Installationsaufgaben wirklich ausf�hren?</Value>
	</LocaleResource>
	<LocaleResource Name="Admin.Configuration.Plugins.ExecuteTasks.Progress">
		...
		<Value lang="de">Die Installationsaufgaben werden ausgef�hrt. Bitte warten...</Value>
	</LocaleResource>
	...
	<LocaleResource Name="Admin.Configuration.Settings.Catalog.LabelAsNewForMaxDays">
		...
		<Value lang="de">Produkt als "neu" kennzeichnen f�r max. [x] Tage</Value>
	</LocaleResource>
