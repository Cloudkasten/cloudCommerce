...
<Language>
  ...
  <LocaleResource Name="Admin.Catalog.Products.Variants.ProductVariantAttributes.Attributes.Values.Fields.Alias.Hint"> 
	...
	<T>Ein optionaler, sprachneutraler Referenzwert f�r interne Zwecke</T>
  </LocaleResource>
  ...
  <LocaleResource Name="Admin.Configuration.ContentSlider.Slide.AddNew">
	...
	<T>Neuen Slide hinzuf�gen</T>
  </LocaleResource>

  <LocaleResource Name="Admin.ContentSlider.Slide.Title.Required">
    <Value>Please enter a title for this slide.</Value>
	<T>Bitte geben Sie f�r diesen Slide eine �berschrift an.</T>
  </LocaleResource>
  
  <LocaleResource Name="Admin.ContentSlider.Slide.ButtonUrl.Required">
    <Value>Please enter a url for this button.</Value>
	<T>Bitte geben Sie f�r diesen Button eine Url an.</T>
  </LocaleResource>
  <LocaleResource Name="Admin.ContentSlider.Slide.ButtonText.Required">
    <Value>Please enter a text for this button.</Value>
	<T>Bitte geben Sie f�r diesen Button einen Text an.</T>
  </LocaleResource>
  <LocaleResource Name="Admin.Configuration.Settings.General.Common.Captcha.Hint">
    <Value>A CAPTCHA is a program that can tell whether its user is a human or a computer. You''ve probably seen them � colorful images with distorted text at the bottom of Web registration forms. CAPTCHAs are used by many websites to prevent abuse from "bots," or automated programs usually written to generate spam. No computer program can read distorted text as well as humans can, so bots cannot navigate sites protected by CAPTCHAs. cloudCommerce.NET uses <a href="http://www.google.com/recaptcha" target="_blank">reCAPTCHA</a>.</Value>
	<T>CAPTCHAs werden verwendet, damit man entscheiden kann, ob das Gegen�ber ein Mensch oder eine Maschine ist. In der Regel macht man dies, um zu pr�fen, ob Eingaben in Internetformulare �ber Menschen oder Maschinen (Roboter, kurz Bot) erfolgt sind, weil Roboter hier oft missbr�uchlich eingesetzt werden. CAPTCHAs dienen also der Sicherheit.</T>
  </LocaleResource>
