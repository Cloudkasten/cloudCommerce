...
namespace cloudCommerce.Services.Seo
{
    ...
    public partial class UrlRecordService : IUrlRecordService
    {
        ...
        private const string URLRECORD_KEY = "cloudCommerce.urlrecord.{0}-{1}-{2}";
		private const string URLRECORD_ALL_ACTIVESLUGS_KEY = "cloudCommerce.urlrecord.all-active-slugs";
		private const string URLRECORD_PATTERN_KEY = "cloudCommerce.urlrecord.";
