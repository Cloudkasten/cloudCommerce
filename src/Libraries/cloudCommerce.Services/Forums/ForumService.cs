...
namespace cloudCommerce.Services.Forums
{
    /// <summary>
    /// Forum service
    /// </summary>
    public partial class ForumService : IForumService
    {
		...
		private const string FORUMGROUP_ALL_KEY = "cloudCommerce.forumgroup.all-{0}";
        private const string FORUM_ALLBYFORUMGROUPID_KEY = "cloudCommerce.forum.allbyforumgroupid-{0}";
        private const string FORUMGROUP_PATTERN_KEY = "cloudCommerce.forumgroup.";
        private const string FORUM_PATTERN_KEY = "cloudCommerce.forum.";
