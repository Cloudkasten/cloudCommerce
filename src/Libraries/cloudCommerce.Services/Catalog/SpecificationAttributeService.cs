...
namespace cloudCommerce.Services.Catalog
{
    ...
    {
        #region Constants
        private const string PRODUCTSPECIFICATIONATTRIBUTE_ALLBYPRODUCTID_KEY = "cloudCommerce.productspecificationattribute.allbyproductid-{0}-{1}-{2}";
        private const string PRODUCTSPECIFICATIONATTRIBUTE_PATTERN_KEY = "cloudCommerce.productspecificationattribute.";
        #endregion
