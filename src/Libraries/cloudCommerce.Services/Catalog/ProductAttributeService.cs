...
namespace cloudCommerce.Services.Catalog
{
    ...
    {
        private const string PRODUCTATTRIBUTES_ALL_KEY = "cloudCommerce.productattribute.all";
		private const string PRODUCTATTRIBUTES_BY_ID_KEY = "cloudCommerce.productattribute.id-{0}";
		private const string PRODUCTATTRIBUTES_PATTERN_KEY = "cloudCommerce.productattribute.";

		private const string PRODUCTVARIANTATTRIBUTES_ALL_KEY = "cloudCommerce.productvariantattribute.all-{0}";
		private const string PRODUCTVARIANTATTRIBUTES_BY_ID_KEY = "cloudCommerce.productvariantattribute.id-{0}";
		// 0 = ProductId, 1 = PageIndex, 2 = PageSize
		private const string PRODUCTVARIANTATTRIBUTES_COMBINATIONS_BY_ID_KEY = "cloudCommerce.productvariantattribute.combinations.id-{0}-{1}-{2}";
		private const string PRODUCTVARIANTATTRIBUTES_PATTERN_KEY = "cloudCommerce.productvariantattribute.";

		private const string PRODUCTVARIANTATTRIBUTEVALUES_ALL_KEY = "cloudCommerce.productvariantattributevalue.all-{0}";
		private const string PRODUCTVARIANTATTRIBUTEVALUES_BY_ID_KEY = "cloudCommerce.productvariantattributevalue.id-{0}";
		private const string PRODUCTVARIANTATTRIBUTEVALUES_PATTERN_KEY = "cloudCommerce.productvariantattributevalue.";	
