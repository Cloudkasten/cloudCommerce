...
namespace cloudCommerce.Services.Catalog
{
    ...
    public partial class CategoryService : ICategoryService
    {
        ...
        private const string CATEGORIES_BY_PARENT_CATEGORY_ID_KEY = "cloudCommerce.category.byparent-{0}-{1}-{2}-{3}";
		private const string PRODUCTCATEGORIES_ALLBYCATEGORYID_KEY = "cloudCommerce.productcategory.allbycategoryid-{0}-{1}-{2}-{3}-{4}-{5}";
		private const string PRODUCTCATEGORIES_ALLBYPRODUCTID_KEY = "cloudCommerce.productcategory.allbyproductid-{0}-{1}-{2}-{3}";
        private const string CATEGORIES_PATTERN_KEY = "cloudCommerce.category.";
        private const string PRODUCTCATEGORIES_PATTERN_KEY = "cloudCommerce.productcategory.";
        private const string CATEGORIES_BY_ID_KEY = "cloudCommerce.category.id-{0}";
