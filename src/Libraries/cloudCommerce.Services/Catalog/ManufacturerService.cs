...
namespace cloudCommerce.Services.Catalog
{
    ...
    {
        #region Constants
        private const string PRODUCTMANUFACTURERS_ALLBYMANUFACTURERID_KEY = "cloudCommerce.productmanufacturer.allbymanufacturerid-{0}-{1}-{2}-{3}-{4}";
        private const string PRODUCTMANUFACTURERS_ALLBYPRODUCTID_KEY = "cloudCommerce.productmanufacturer.allbyproductid-{0}-{1}-{2}";
        private const string MANUFACTURERS_PATTERN_KEY = "cloudCommerce.manufacturer.";
        private const string MANUFACTURERS_BY_ID_KEY = "cloudCommerce.manufacturer.id-{0}";
        private const string PRODUCTMANUFACTURERS_PATTERN_KEY = "cloudCommerce.productmanufacturer.";
