...
namespace cloudCommerce.Services.Catalog
{
    ...
    public partial class RecentlyViewedProductsService : IRecentlyViewedProductsService
    {
        ...
        protected IList<int> GetRecentlyViewedProductsIds(int number)
        {
            ...
            var recentlyViewedCookie = _httpContext.Request.Cookies.Get("cloudCommerce.RecentlyViewedProducts");
        ...
        public virtual void AddProductToRecentlyViewedList(int productId)
        {
			...
			{
				recentlyViewedCookie = new HttpCookie("cloudCommerce.RecentlyViewedProducts");
