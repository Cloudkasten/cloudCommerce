...
namespace cloudCommerce.Services.Directory
{
    ...
    {
        #region Constants
        private const string CURRENCIES_ALL_KEY = "cloudCommerce.currency.all-{0}";
        private const string CURRENCIES_PATTERN_KEY = "cloudCommerce.currency.";
        private const string CURRENCIES_BY_ID_KEY = "cloudCommerce.currency.id-{0}";
        #endregion
