...
namespace cloudCommerce.Services.Directory
{
    ...
    {
        #region Constants
        private const string STATEPROVINCES_ALL_KEY = "cloudCommerce.stateprovince.all-{0}";
        private const string STATEPROVINCES_PATTERN_KEY = "cloudCommerce.stateprovince.";
        #endregion
