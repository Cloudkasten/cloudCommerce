...
namespace cloudCommerce.Services.Directory
{
    ...
    {
        #region Constants
        private const string COUNTRIES_ALL_KEY = "cloudCommerce.country.all-{0}";
        private const string COUNTRIES_BILLING_KEY = "cloudCommerce.country.billing-{0}";
        private const string COUNTRIES_SHIPPING_KEY = "cloudCommerce.country.shipping-{0}";
        private const string COUNTRIES_PATTERN_KEY = "cloudCommerce.country.";
        #endregion
