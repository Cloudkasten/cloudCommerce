...
namespace cloudCommerce.Services.Directory
{
    ...
    {
        #region Constants
        private const string MEASUREDIMENSIONS_ALL_KEY = "cloudCommerce.measuredimension.all";
        private const string MEASUREWEIGHTS_ALL_KEY = "cloudCommerce.measureweight.all";
        private const string MEASUREDIMENSIONS_PATTERN_KEY = "cloudCommerce.measuredimension.";
        private const string MEASUREWEIGHTS_PATTERN_KEY = "cloudCommerce.measureweight.";
        private const string MEASUREDIMENSIONS_BY_ID_KEY = "cloudCommerce.measuredimension.id-{0}";
        private const string MEASUREWEIGHTS_BY_ID_KEY = "cloudCommerce.measureweight.id-{0}";
        #endregion
