...
namespace cloudCommerce.Services.Localization
{
    /// <summary>
    /// Language service
    /// </summary>
    ...
    {
        #region Constants
        private const string LANGUAGES_ALL_KEY = "cloudCommerce.language.all-{0}";
        private const string LANGUAGES_COUNT = "cloudCommerce.language.count-{0}";
        private const string LANGUAGES_BY_CULTURE_KEY = "cloudCommerce.language.culture-{0}";
        private const string LANGUAGES_BY_SEOCODE_KEY = "cloudCommerce.language.seocode-{0}";
        private const string LANGUAGES_PATTERN_KEY = "cloudCommerce.language.";
        private const string LANGUAGES_BY_ID_KEY = "cloudCommerce.language.id-{0}";
        #endregion
