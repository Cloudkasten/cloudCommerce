...
namespace cloudCommerce.Services.Messages
{
    public partial class MessageTemplateService: IMessageTemplateService
    {
        ...
        private const string MESSAGETEMPLATES_ALL_KEY = "cloudCommerce.messagetemplate.all-{0}";
        private const string MESSAGETEMPLATES_BY_NAME_KEY = "cloudCommerce.messagetemplate.name-{0}-{1}";
        private const string MESSAGETEMPLATES_PATTERN_KEY = "cloudCommerce.messagetemplate.";
