...
namespace cloudCommerce.Services.Common
{
    ...
    public partial class GenericAttributeService : IGenericAttributeService
    {
        ...
        private const string GENERICATTRIBUTE_KEY = "cloudCommerce.genericattribute.{0}-{1}";
        private const string GENERICATTRIBUTE_PATTERN_KEY = "cloudCommerce.genericattribute.";
        #endregion
