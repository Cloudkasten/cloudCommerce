...
namespace cloudCommerce.Services.Tax
{
    ...
    {
        #region Constants
        private const string TAXCATEGORIES_ALL_KEY = "cloudCommerce.taxcategory.all";
        private const string TAXCATEGORIES_PATTERN_KEY = "cloudCommerce.taxcategory.";
        private const string TAXCATEGORIES_BY_ID_KEY = "cloudCommerce.taxcategory.id-{0}";
        #endregion
