...
namespace cloudCommerce.Services.Customers
{
	...
	public partial class CustomerService : ICustomerService
    {
        ...
        private const string CUSTOMERROLES_ALL_KEY = "cloudCommerce.customerrole.all-{0}";
        private const string CUSTOMERROLES_BY_SYSTEMNAME_KEY = "cloudCommerce.customerrole.systemname-{0}";
        private const string CUSTOMERROLES_PATTERN_KEY = "cloudCommerce.customerrole.";
