...
namespace cloudCommerce.Services.Stores
{
	...
	public partial class StoreMappingService : IStoreMappingService
	{
		...
		private const string STOREMAPPING_BY_ENTITYID_NAME_KEY = "cloudCommerce.storemapping.entityid-name-{0}-{1}";
		private const string STOREMAPPING_PATTERN_KEY = "cloudCommerce.storemapping.";
