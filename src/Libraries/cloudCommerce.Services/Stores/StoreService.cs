...
namespace cloudCommerce.Services.Stores
{
	/// <summary>
	/// Store service
	/// </summary>
	...
	{
		#region Constants
		private const string STORES_ALL_KEY = "cloudCommerce.stores.all";
		private const string STORES_PATTERN_KEY = "cloudCommerce.stores.";
        private const string STORES_BY_ID_KEY = "cloudCommerce.stores.id-{0}";
		#endregion
