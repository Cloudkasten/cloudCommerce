...
namespace cloudCommerce.Services.Themes
{

    public class ThemeVariablesService : IThemeVariablesService
    {
        private const string THEMEVARS_BY_THEME_KEY = "cloudCommerce.themevars.theme-{0}-{1}";
        private const string THEMEVARS_PATTERN_KEY = "cloudCommerce.themevars.";
