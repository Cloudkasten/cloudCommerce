...
namespace cloudCommerce.Services.Topics
{
    /// <summary>
    /// Topic service
    /// </summary>
    ...
    {
		private const string TOPICS_ALL_KEY = "cloudCommerce.topics.all-{0}";
		private const string TOPICS_PATTERN_KEY = "cloudCommerce.topics.";
