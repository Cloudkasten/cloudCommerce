...
namespace cloudCommerce.Services.Security
{
    ...
    public partial class AclService : IAclService
    {
        ...
        private const string ACLRECORD_BY_ENTITYID_NAME_KEY = "cloudCommerce.aclrecord.entityid-name-{0}-{1}";
        private const string ACLRECORD_PATTERN_KEY = "cloudCommerce.aclrecord.";
