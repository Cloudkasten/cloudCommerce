...
namespace cloudCommerce.Services.Security
{
	...
	public partial class PermissionService : IPermissionService
    {
        ...
        /// </remarks>
        private const string PERMISSIONS_ALLOWED_KEY = "cloudCommerce.permission.allowed-{0}-{1}";
        private const string PERMISSIONS_PATTERN_KEY = "cloudCommerce.permission.";
        #endregion
