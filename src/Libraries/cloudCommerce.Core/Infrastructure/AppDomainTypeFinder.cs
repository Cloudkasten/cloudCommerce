...
{
    /// <summary>
    /// A class that finds types needed by cloudCommerce by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        /// <summary>
		/// Gets or sets wether cloudCommerce should iterate assemblies in the app domain when loading cloudCommerce types. Loading patterns are applied when loading these assemblies.
		/// </summary>
		...
		/// </summary>
        /// <remarks>
		/// If you change this so that cloudCommerce assemblies aren't investigated (e.g. by not including something like "^cloudCommerce|..." you may break core functionality.
		/// </remarks>
        ...
        /// <returns>A list of assemblies that should be loaded by the cloudCommerce factory.</returns>
        ...
        /// <returns>True if the assembly should be loaded into cloudCommerce.</returns>
