	...
	public abstract class InvariantSeedData
	{
		...
		public IList<ScheduleTask> ScheduleTasks()
		{
			var entities = new List<ScheduleTask>
			{
				new ScheduleTask
				{
					...
					Type = "cloudCommerce.Services.Messages.QueuedMessagesSendTask, cloudCommerce.Services",
					Enabled = true,
					StopOnError = false,
				},
				new ScheduleTask
				{
					...
					Type = "cloudCommerce.Services.Customers.DeleteGuestsTask, cloudCommerce.Services",
					Enabled = true,
					StopOnError = false,
				},
				new ScheduleTask
				{
					...
					Type = "cloudCommerce.Services.Logging.DeleteLogsTask, cloudCommerce.Services",
					Enabled = true,
					StopOnError = false,
				},
				new ScheduleTask
				{
					...
					Type = "cloudCommerce.Services.Caching.ClearCacheTask, cloudCommerce.Services",
					Enabled = false,
					StopOnError = false,
				},
				new ScheduleTask
				{
					...
					Type = "cloudCommerce.Services.Directory.UpdateExchangeRateTask, cloudCommerce.Services",
					Enabled = true,
					StopOnError = false,
				},
				new ScheduleTask
				{
					...
					Type = "cloudCommerce.Services.Media.TransientMediaClearTask, cloudCommerce.Services",
					Enabled = true,
					StopOnError = false,
				},
				new ScheduleTask
				{
					...
					Type = "cloudCommerce.Services.Messages.QueuedMessagesClearTask, cloudCommerce.Services",
					Enabled = true,
					StopOnError = false,
				},
				new ScheduleTask
				{
					...
					Type = "cloudCommerce.Services.Common.TempFileCleanupTask, cloudCommerce.Services",
					Enabled = true,
					StopOnError = false
				}
			};
		...
		public IList<BlogPost> BlogPosts()
		{
			...
			var blogPostCustomerService = new BlogPost()
			{
				...
				Tags = "e-commerce, cloudCommerce.NET, asp.net, sample tag, money",
		...
		public IList<NewsItem> NewsItems()
		{
			...
			var news1 = new NewsItem()
			{
				AllowComments = true,
				Language = defaultLanguage,
				Title = "cloudCommerce.NET new release!",
                Short = "cloudCommerce.NET includes everything you need to begin your e-commerce online store.",
                Full = "<p>cloudCommerce.NET includes everything you need to begin your e-commerce online store.<br/>  We have thought of everything and it's all included!<br/><br/cloudCommerce.NET is a fully customizable shop-system. It's stable and highly usable.<br>  From downloads to documentation, www.smartstore.com offers a comprehensive base of information, resources, and support to the cloudCommerce.NET community.</p>",
				Published = true,
                MetaTitle = "cloudCommerce.NET new release!",
			...
			var news2 = new NewsItem()
			{
                ...
                Short = "The new cloudCommerce.NET store is open now!  We are very excited to offer our new range of products. We will be constantly adding to our range so please register on our site, this will enable you to keep up to date with any new products.",
