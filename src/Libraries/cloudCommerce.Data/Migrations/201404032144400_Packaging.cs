	...
	public partial class Packaging : DbMigration, ILocaleResourcesProvider, IDataSeeder<SmartObjectContext>
    {
		...
		public void MigrateLocaleResources(LocaleResourcesBuilder builder)
		{
			...
			builder.AddOrUpdate("Admin.Packaging.Dialog.ThemeInfo",
				"Choose the theme package file (cloudCommerce.Theme.*.nupkg) to upload to your server. The package will be automatically extracted and installed. If an older version of the theme already exists, it will be backed up for you.",
				"W�hlen Sie die Theme Paket-Datei (cloudCommerce.Theme.*.nupkg), die Sie auf den Server hochladen m�chten. Das Paket wird autom. extrahiert und installiert. Wenn eine �ltere Version des Themes bereits existiert, wird eine Sicherungskopie davon erstellt.");

			builder.AddOrUpdate("Admin.Packaging.Dialog.PluginInfo",
				"Choose a plugin package file (cloudCommerce.Plugin.*.nupkg) to upload to your server. The package will be automatically extracted and installed. If an older version of the plugin already exists, it will be backed up for you.",
				"W�hlen Sie die Plugin Paket-Datei (cloudCommerce.Plugin.*.nupkg), die Sie auf den Server hochladen m�chten. Das Paket wird autom. extrahiert und installiert. Wenn eine �ltere Version des Plugins bereits existiert, wird eine Sicherungskopie davon erstellt.");

			builder.AddOrUpdate("Admin.Packaging.NotAPackage",
				"Package file is invalid. Please upload a 'cloudCommerce.*.nupkg' file.",
				"Paket-Datei ist ung�ltig. Bitte laden Sie eine 'cloudCommerce.*.nupkg' Datei hoch.");
			...
			builder.AddOrUpdate("Admin.Packaging.IsIncompatible",
				"The package is not compatible the current app version {0}. Please update cloudCommerce.NET or install another version of this package.",
				"Das Paket ist nicht kompatibel mit der aktuallen Programmversion {0}. Bitte aktualisieren Sie cloudCommerce.NET oder nutzen Sie eine andere, kompatible Paket-Version.");
			...
			builder.AddOrUpdate("Admin.Packaging.TooManyBackups",
				...
				"Sicherungsordner {0} enth�lt zu viele Unterordner (Obergrenze ist 1.000)");
			...
			builder.AddOrUpdate("Admin.Configuration.Plugins.Description.Step1",
				"Use the <a id='{0}' href='{1}' data-toggle='modal'>package uploader</a> or upload the plugin manually - eg. via FTP - to the <i>/Plugins</i> folder in your cloudCommerce.NET directory.",
			...
			builder.AddOrUpdate("Products.Bundle.YouSave")
				...
				.Value("de", "Im Set f�r nur {0} statt {1}");
