namespace cloudCommerce.Data.Migrations
{
	...
	public partial class ExportFramework : DbMigration, ILocaleResourcesProvider, IDataSeeder<SmartObjectContext>
    {
		...
		public void MigrateLocaleResources(LocaleResourcesBuilder builder)
		{
			...
			builder.AddOrUpdate("Admin.Validation.Url", "Please enter a valid URL", "Bitte geben Sie eine g�ltige URL ein");
			builder.AddOrUpdate("Admin.Validation.Name", "Please enter a name", "Bitte geben Sie einen Namen ein");
			builder.AddOrUpdate("Admin.Validation.EmailAddress", "Please enter a valid email address", "Bitte geben Sie eine g�ltige E-Mail Adresse ein");
			...
			builder.AddOrUpdate("Admin.DataExchange.Export.BatchSize",
				...
				"Legt die maximale Anzahl der Datens�tze pro Exportdatei fest. 0 ist der Standard und bedeutet, dass alle Datens�tze in eine Datei exportiert werden.");
			...
			builder.AddOrUpdate("Admin.DataExchange.Export.PerStore",
				...
				"Legt fest, ob f�r jeden Shop ein separater Verarbeitungsdurchlauf erfolgen soll. F�r jeden Shop wird eine neue Datei erzeugt.");
			...
			builder.AddOrUpdate("Admin.DataExchange.Export.CreateZipArchive",
				...
				"Legt fest, ob die Exportdateien in einem ZIP-Archiv zusammengefasst werden sollen. Das Archiv verbleibt im tempor�ren Ordner des Exportprofils ohne weitere Vearbeitung.");

			builder.AddOrUpdate("Admin.DataExchange.Export.Cleanup",
				"Clean up at the end",
				"Zum Schluss aufr�umen",
				"Specifies whether to delete unneeded files after deployment.",
				"Legt fest, ob nicht mehr ben�tigte Dateien nach der Bereitstellung gel�scht werden sollen.");

			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.DataExchange.ExportEntityType.Product", "Product", "Produkt");
			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.DataExchange.ExportEntityType.Category", "Category", "Warengruppe");
			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.DataExchange.ExportEntityType.Manufacturer", "Manufacturer", "Hersteller");
			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.DataExchange.ExportEntityType.Customer", "Customer", "Kunde");
			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.DataExchange.ExportEntityType.Order", "Order", "Auftrag");
			...
			builder.AddOrUpdate("Admin.DataExchange.Export.Projection.CurrencyId",
				...
				"Legt die auf den Export anzuwendende W�hrung fest.");
			...
			builder.AddOrUpdate("Admin.DataExchange.Export.Projection.CustomerId",
				...
				"Legt die ID des Kunden fest, auf den sich der Export beziehen soll. Wird z.B. bei Preisberechnungen ber�cksichtigt.");
			...
			builder.AddOrUpdate("Admin.DataExchange.Export.Projection.DescriptionToPlainText",
				...
				"Legt fest, ob f�r den Export alle HTML-Auszeichnungen aus der Artikelbeschreibung entfernt werden sollen.");
			...
			builder.AddOrUpdate("Admin.DataExchange.Export.Projection.AppendDescriptionText",
				...
				"Legt den an die Artikelbeschreibung anzuh�ngenden Text fest. Bei mehreren Texten wird einer per Zufall ausgew�hlt.");
			...
			builder.AddOrUpdate("Admin.DataExchange.Export.Projection.Brand",
				...
				"Legt den zu exportierenden Hersteller bzw. die Marke fest, wenn f�r ein Produkt kein Hersteller zugeordnet ist.");
			...
			builder.AddOrUpdate("Admin.DataExchange.Export.Projection.PictureSize",
				...
				"Legt die Gr��e (in Pixel) des Produktbildes fest.");
			...
			builder.AddOrUpdate("Admin.DataExchange.Export.Projection.ShippingTime",
				...
				"Legt die Lieferzeit f�r Produkte fest, wo diese nicht angegeben ist.");
			...
			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.DataExchange.ExportDeploymentType.FileSystem", "File system", "Dateisystem");
			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.DataExchange.ExportDeploymentType.Email", "Email", "E-Mail");
			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.DataExchange.ExportDeploymentType.Http", "HTTP", "HTTP");
			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.DataExchange.ExportDeploymentType.Ftp", "FTP", "FTP");

			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.DataExchange.ExportDescriptionMerging.None",
				"Not specified", "Nicht spezifiziert");
			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.DataExchange.ExportDescriptionMerging.ShortDescriptionOrNameIfEmpty",
				"Short description or name if empty", "Kurzbeschreibung oder Name falls leer");
			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.DataExchange.ExportDescriptionMerging.ShortDescription",
				"Short description", "Kurzbeschreibung");
			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.DataExchange.ExportDescriptionMerging.Description",
				"Description", "Detailbeschreibung");
			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.DataExchange.ExportDescriptionMerging.NameAndShortDescription",
				"Product name + short description", "Produktname + Kurzbeschreibung");
			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.DataExchange.ExportDescriptionMerging.NameAndDescription",
				"Product name + long description", "Produktname + Detailbeschreibung");
			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.DataExchange.ExportDescriptionMerging.ManufacturerAndNameAndShortDescription",
				"Manufacturer + Product name + short description", "Hersteller + Produktname + Kurzbeschreibung");
			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.DataExchange.ExportDescriptionMerging.ManufacturerAndNameAndDescription",
			...
			builder.AddOrUpdate("Admin.DataExchange.Export.Deployment.IsPublic",
				...
				"In �ffentlichen Ordner kopieren",
				"Specifies whether to copy the exported data into a folder that is accessible through the internet.",
				"Legt fest, ob die exportierten Daten in einen �bers Internet zug�nglichen Ordner kopiert werden sollen.");
			...
			builder.AddOrUpdate("Admin.DataExchange.Export.Deployment.Url",
				...
				"Legt die URL bzw. den Host-Namen fest, an die die Daten �bermittelt werden sollen.");
			...
			builder.AddOrUpdate("Admin.DataExchange.Export.Deployment.EmailAccountId",
				...
				"Legt das E-Mail Konto fest, �ber welches die Daten verschickt werden sollen.");
		}
    }
}
