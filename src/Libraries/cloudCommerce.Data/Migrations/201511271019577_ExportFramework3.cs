namespace cloudCommerce.Data.Migrations
{
	...
	public partial class ExportFramework3 : DbMigration, ILocaleResourcesProvider, IDataSeeder<SmartObjectContext>
	{
		...
		public void MigrateLocaleResources(LocaleResourcesBuilder builder)
		{
			...
			builder.AddOrUpdate("Admin.Common.TemporaryFiles", "Temporary files", "Tempor�re Dateien");
			builder.AddOrUpdate("Admin.Common.PublicFiles", "Public files", "�ffentliche Dateien");
			builder.AddOrUpdate("Admin.Common.Of", "of", "von");

			builder.AddOrUpdate("Admin.Common.NoTempFilesFound",
				"There are no temporary files.",
				"Es sind keine tempor�ren Dateien vorhanden.");

			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.DataExchange.ExportEntityType.NewsLetterSubscription",
			...
			builder.AddOrUpdate("Admin.DataExchange.Export.IsSystemProfile",
				...
				"Gibt an, ob es sich bei dem Exportprofil um eine Systemprofil handelt. Systemprofile k�nnen nicht entfernt werden.");

			builder.AddOrUpdate("Admin.DataExchange.Export.CannotDeleteSystemProfile",
				"Cannot delete a system export profile.",
				"Ein System-Exportprofil kann nicht gel�scht werden.");
			...
			builder.AddOrUpdate("Admin.Configuration.Payment.Methods.RestrictionNote",
				...
				"Es wurden keine M�glichkeiten zur Einschr�nkung von Zahlungsarten gefunden.");
			...
			builder.AddOrUpdate("Admin.Configuration.Shipping.Methods.RestrictionNote",
				...
				"Es wurden keine M�glichkeiten zur Einschr�nkung von Versandarten gefunden.");
			...
			builder.Delete(
				...
				"Enums.cloudCommerce.Core.Domain.Common.AmountRestrictionContextType.SubtotalAmount",
				"Enums.cloudCommerce.Core.Domain.Common.AmountRestrictionContextType.TotalAmount",
				"Enums.cloudCommerce.Core.Domain.Common.CountryRestrictionContextType.BillingAddress",
				"Enums.cloudCommerce.Core.Domain.Common.CountryRestrictionContextType.ShippingAddress",
