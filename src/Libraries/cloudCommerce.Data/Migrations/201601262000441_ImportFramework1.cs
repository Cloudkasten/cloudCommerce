namespace cloudCommerce.Data.Migrations
{
	...
	public partial class ImportFramework1 : DbMigration, ILocaleResourcesProvider, IDataSeeder<SmartObjectContext>
	{
		...
		public void MigrateLocaleResources(LocaleResourcesBuilder builder)
		{
			...
			builder.AddOrUpdate("Admin.Common.UnsupportedEntityType", "Unsupported entity type '{0}'", "Nicht unterst�tzter Entit�tstyp '{0}'");
			...
			builder.AddOrUpdate("Common.CaptchaUnableToVerify",
				...
				"Der API-Aufruf zur Pr�fung eines CAPTCHAs ist fehlgeschlagen.");
			...
			builder.AddOrUpdate("DownloadableProducts.UserAgreementConfirmation",
				...
				"Ja, ich stimme der <a href='javascript:void(0)' data-id='{0}' class='download-user-agreement'>Nutzungsvereinbarung</a> f�r dieses Produkt zu.");
			...
			builder.AddOrUpdate("Checkout.DownloadUserAgreement.PleaseAgree",
				...
				"Bitte stimmen Sie der Nutzungsvereinbarung f�r herunterladbare Produkte zu.");
			...
			builder.AddOrUpdate("Admin.Configuration.Settings.ShoppingCart.ShowEsdRevocationWaiverBox",
				...
				"Widerrufsverzichtbox f�r elektronische Leistungen anzeigen",
				"Specifies whether the customer must agree a revocation waiver for electronic services on the order confirmation page.",
				"Legt fest, ob der Kunde auf der Bestellabschlussseite einem Widerrufsverzicht f�r elektronische Leistungen zustimmen muss.");
			...
			builder.AddOrUpdate("Admin.Configuration.Settings.ShoppingCart.ShowConfirmOrderLegalHint",
				...
				"Rechtliche Hinweise in der Warenkorb�bersicht anzeigen",
				...
				"Legt fest, ob rechtliche Hinweise in der Warenkorb�bersicht auf der Bestellabschlu�seite angezeigt werden. Dieser Text kann in den Sprachresourcen ge�ndert werden.");
			...
			builder.AddOrUpdate("Checkout.EsdRevocationWaiverConfirmation",
				...
				"Ja, ich m�chte sofort Zugang zu dem digitalen Inhalt und wei�, dass mein Widerrufsrecht mit dem Zugang erlischt.");
			...
			builder.AddOrUpdate("Checkout.EsdRevocationWaiverConfirmation.PleaseAgree",
				...
				"Bitte best�tigen Sie, dass Sie sofort Zugang zu dem digitalen Inhalt w�nschen.");


			builder.AddOrUpdate("Admin.Configuration.Settings.DataExchange.MaxFileNameLength",
				"Maximum length of file and folder names",
				"Maximale L�nge von Datei- und Ordnernamen",
				"Specifies the maximum length of file and folder names created during an import or export.",
				"Legt die maximale L�nge von Datei- und Ordnernamen fest, die im Rahmen eines Imports\\Exports erzeugt wurden.");
			...
			builder.AddOrUpdate("Admin.DataExchange.Import.KeyFieldNames.Note",
				...
				"Benutzen Sie das ID-Feld bitte nur dann als Schl�sselfeld, wenn die Daten aus der derselben Datenbank stammen, in der sie importiert werden sollen. Ansonsten werden u.U. die falschen Datens�tze aktualisiert.");
			...
			builder.AddOrUpdate("Admin.Configuration.Settings.ShoppingCart.NewsLetterSubscription",
				...
				"Legt fest, ob Kunden bei einer Bestellung Newsletter abonnieren k�nnen und ob die Checkbox standardm��ig aktiviert ist.");

			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.Orders.CheckoutNewsLetterSubscription.None", "Do not show", "Nicht anzeigen");
			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.Orders.CheckoutNewsLetterSubscription.Deactivated", "Show deactivated", "Deaktiviert anzeigen");
			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.Orders.CheckoutNewsLetterSubscription.Activated", "Show activated", "Aktiviert anzeigen");
