namespace cloudCommerce.Data.Migrations
{
	...
	public partial class V211 : DbMigration, ILocaleResourcesProvider, IDataSeeder<SmartObjectContext>
    {
		...
		public void MigrateLocaleResources(LocaleResourcesBuilder builder)
		{
			...
			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.Seo.CanonicalHostNameRule.NoRule",
				"Don't apply",
				"Nicht anwenden");
			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.Seo.CanonicalHostNameRule.RequireWww",
				"Require www prefix",
				"www-Pr�fix erzwingen");
			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.Seo.CanonicalHostNameRule.OmitWww",
				"Omit www prefix",
			...
			builder.AddOrUpdate("Checkout.ConfirmYourOrder",
				...
				"Bitte best�tigen Sie Ihren Auftrag.");
			...
			builder.AddOrUpdate("Checkout.ConfirmHint",
				...
				"Bitte pr�fen Sie die Gesamtsumme und die Rechnungsadresse. Bei abweichender Lieferanschrift pr�fen Sie bitte auch diese. �nderungen k�nnen Sie jederzeit mit einem Klick auf <strong>zur�ck</strong> vornehmen. Sind alle Daten richtig, best�tigen Sie bitte mit einem Klick auf <strong>kaufen</strong> Ihre Bestellung.");
			...
			builder.AddOrUpdate("Admin.Common.ExportToPdf.TooManyItems",
				...
				"Zu viele Objekte! Mehr als 500 Objekte k�nnen nicht konvertiert werden. Bitte reduzieren Sie die Anzahl ausgew�hlter Datens�tze.");
