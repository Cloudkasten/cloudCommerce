namespace cloudCommerce.Data.Migrations
{
	...
	public partial class ExportFramework1 : DbMigration, ILocaleResourcesProvider, IDataSeeder<SmartObjectContext>
    {
		...
		public void Seed(SmartObjectContext context)
		{
			...
			context.Execute("DELETE FROM [dbo].[ScheduleTask] WHERE [Type] = 'cloudCommerce.Billiger.StaticFileGenerationTask, cloudCommerce.Billiger'");
			context.Execute("DELETE FROM [dbo].[ScheduleTask] WHERE [Type] = 'cloudCommerce.ElmarShopinfo.StaticFileGenerationTask, cloudCommerce.ElmarShopinfo'");
			context.Execute("DELETE FROM [dbo].[ScheduleTask] WHERE [Type] = 'cloudCommerce.Guenstiger.StaticFileGenerationTask, cloudCommerce.Guenstiger'");
			context.Execute("DELETE FROM [dbo].[ScheduleTask] WHERE [Type] = 'cloudCommerce.Shopwahl.StaticFileGenerationTask, cloudCommerce.Shopwahl'");
		...
		public void MigrateLocaleResources(LocaleResourcesBuilder builder)
		{
			...
			builder.AddOrUpdate("Common.Public", "public", "�ffentlich");
			...
			builder.AddOrUpdate("Admin.DataExchange.Export.CompletedEmail.Body",
				...
				"Dies ist eine automatische Benachrichtung von Shop \"{0}\" �ber einen erfolgten Datenexport.");
			...
			builder.AddOrUpdate("Admin.DataExchange.Export.FolderAndFileName.Validate",
				...
				"Bitte einen g�ltigen Ordner- und Dateinamen eingeben. Beispiel f�r Dateinamen: %File.Index%-%Profile.Id%-gmc-%Store.Name%");
			...
			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.DataExchange.ExportAttributeValueMerging.None",
				"Not specified", "Nicht spezifiziert");
			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.DataExchange.ExportAttributeValueMerging.AppendAllValuesToName",
			...
			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.DataExchange.ExportHttpTransmissionType.SimplePost", "Simple POST", "Einfacher POST");
			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.DataExchange.ExportHttpTransmissionType.MultipartFormDataPost", "Multipart form data POST", "Multipart-Form-Data POST");
			...
			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.DataExchange.ExportOrderStatusChange.None", "None", "Keine");
			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.DataExchange.ExportOrderStatusChange.Processing", "Processing", "Wird bearbeitet");
			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.DataExchange.ExportOrderStatusChange.Complete", "Complete", "Komplett");
