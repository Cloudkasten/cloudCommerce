	...
	public partial class SendEmailsManually : DbMigration, ILocaleResourcesProvider, IDataSeeder<SmartObjectContext>
    {
		...
		public void MigrateLocaleResources(LocaleResourcesBuilder builder)
		{
			...
			builder.AddOrUpdate("Admin.System.QueuedEmails.Fields.SendManually",
				...
				"Legt fest, ob die E-Mail ausschlie�lich manuell gesendet werden soll.");
			...
			builder.AddOrUpdate("Admin.ContentManagement.MessageTemplates.Fields.SendManually",
				...
				"Legt fest, ob E-Mails, die von dieser Nachrichtenvorlage abgeleitet sind, ausschlie�lich manuell gesendet werden sollen.");
			...
			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.Catalog.SubCategoryDisplayType.Hide",
				"Do not display",
				"Nicht anzeigen");

			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.Catalog.SubCategoryDisplayType.AboveProductList",
				"Above product list",
				"�ber der Produktliste");

			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.Catalog.SubCategoryDisplayType.Bottom",
				"At bottom of page",
				"Am Seitenende");
		}
    }
