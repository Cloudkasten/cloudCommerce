	...
	public partial class CountryMultistore : DbMigration, ILocaleResourcesProvider, IDataSeeder<SmartObjectContext>
    {
		...
		public void MigrateLocaleResources(LocaleResourcesBuilder builder)
		{
			builder.AddOrUpdate("Admin.ContentManagement.Forums.ForumGroup.Fields.SeName",
				...
				"Legt einen Suchmaschinen-freundlichen Seitennamen f�r die Forengruppe fest. 'Tolle Forengruppe' resultiert bspw. in '~/tolle-forengruppe'. Standard ist der Name der Forengruppe.");
			...
			builder.AddOrUpdate("Admin.ContentManagement.Forums.Forum.Fields.SeName",
				...
				"Legt einen Suchmaschinen-freundlichen Seitennamen f�r das Forum fest. 'Tolles Forum' resultiert bspw. in '~/tolles-forum'. Standard ist der Name des Forums.");
		}
    }
}
