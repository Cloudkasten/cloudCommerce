namespace cloudCommerce.Data.Migrations
{
	...
	public partial class Providers : DbMigration, ILocaleResourcesProvider, IDataSeeder<SmartObjectContext>
    {
		...
		public void MigrateLocaleResources(LocaleResourcesBuilder builder)
		{
			...
			builder.AddOrUpdate("Admin.Configuration.ActivityLog.ActivityLog").Value("de", "Aktivit�tslog");
			builder.AddOrUpdate("Admin.Configuration.ActivityLog.ActivityLogTy pe").Value("de", "Aktivit�tstypen");
			...
			builder.AddOrUpdate("Admin.SaveBeforeEdit",
				...
				"Um fortfahren zu k�nnen, muss der Datensatz zun�chst gespeichert werden.");
			...
			builder.AddOrUpdate("Admin.Configuration.Settings.Catalog.FilterEnabled.Hint")
				...
				.Value("de", "Aktiviert die Filterfunktion f�r Produkte in Warengruppen.");
			...
			builder.AddOrUpdate("Admin.Configuration.Settings.ShoppingCart.RoundPricesDuringCalculation.Hint")
				...
				.Value("de", "Bestimmt, ob der Shop bei Berechnungen gerundete Werte der Preise benutzt (empfohlen f�r B2B)");
