	...
	public partial class PaymentMethodDescription : DbMigration, ILocaleResourcesProvider, IDataSeeder<SmartObjectContext>
    {
		...
		public void MigrateLocaleResources(LocaleResourcesBuilder builder)
		{
			...
			builder.AddOrUpdate("Admin.Configuration.Payment.Methods.FullDescription",
				...
				"Legt eine vollst�ndige Beschreibung der Zahlungsmethode fest. Sie erscheint in der Zahlungsliste im Kassenbereich.");
			...
			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.Catalog.PriceDisplayType.LowestPrice",
				"Minimum feasible price",
				"Minimal realisierbarer Preis");

			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.Catalog.PriceDisplayType.PreSelectedPrice",
				"Price preselected on detail page",
				"Auf der Detailseite vorgew�hlter Preis");

			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.Catalog.PriceDisplayType.PriceWithoutDiscountsAndAttributes",
				"Price without discounts and attributes",
				"Preis ohne Rabatte und Attribute");

			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.Catalog.PriceDisplayType.Hide",
				"No price indication",
				"Keine Preisanzeige");
		}
    }
