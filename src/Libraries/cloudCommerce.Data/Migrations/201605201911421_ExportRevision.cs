namespace cloudCommerce.Data.Migrations
{
	...
	public partial class ExportRevision : DbMigration, ILocaleResourcesProvider, IDataSeeder<SmartObjectContext>
	{
		...
		public void MigrateLocaleResources(LocaleResourcesBuilder builder)
		{
			...
			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.DataExchange.ExportDeploymentType.Http", "HTTP POST", "HTTP POST");
			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.DataExchange.ExportDeploymentType.PublicFolder", "Public folder", "�ffentlicher Ordner");
