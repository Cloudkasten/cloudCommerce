	...
	public partial class V22Res : DbMigration, ILocaleResourcesProvider, IDataSeeder<SmartObjectContext>
	{
		...
		public void MigrateLocaleResources(LocaleResourcesBuilder builder)
		{
			...
			builder.AddOrUpdate("Admin.Configuration.Themes.Option.SaveThemeChoiceInCookie.Hint",
				...
				"Wenn nicht gew�hlt, wird das Benutzer Theme mit dem Kundenkonto verkn�pft, was u.U. unerw�nscht sein kann, wenn sich bspw. mehrere User einen Gastzugang teilen.");
			...
			builder.AddOrUpdate("ShoppingCart.AttributeError",
				...
				"Ein unbekannter Fehler ist bei der Pr�fung der ausgew�hlten Produktvariante aufgetreten.");
