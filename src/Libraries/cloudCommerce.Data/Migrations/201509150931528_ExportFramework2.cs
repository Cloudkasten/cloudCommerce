namespace cloudCommerce.Data.Migrations
{
	...
	public partial class ExportFramework2 : DbMigration, ILocaleResourcesProvider, IDataSeeder<SmartObjectContext>
    {
		...
		public void Seed(SmartObjectContext context)
		{
			...
			context.Execute("DELETE FROM [dbo].[ScheduleTask] WHERE [Type] = 'cloudCommerce.GoogleMerchantCenter.StaticFileGenerationTask, cloudCommerce.GoogleMerchantCenter'");
			context.Execute("DELETE FROM [dbo].[ScheduleTask] WHERE [Type] = 'cloudCommerce.BMEcat.StaticFileGenerationTask, cloudCommerce.BMEcat'");
		...
		public void MigrateLocaleResources(LocaleResourcesBuilder builder)
		{
			...
			builder.AddOrUpdate("Admin.Common.Selected", "Selected", "Ausgew�hlte");
			...
			builder.AddOrUpdate("Admin.Common.FoldersDeleted",
				...
				"{0} Verzeichnisse wurden gel�scht");
			...
			builder.AddOrUpdate("Admin.Common.NoEntriesSelected",
				...
				"Es wurden keine Eintr�ge ausgew�hlt.");
			...
			builder.AddOrUpdate("Admin.DataExchange.Export.NotPreviewCompatible",
				...
				"Diese Option wird in der Vorschau nicht ber�cksichtigt.");

			builder.AddOrUpdate("Admin.DataExchange.Export.CloneProfile",
				"Apply settings from",
				"Einstellungen �bernehmen von",
				"Specifies an export profile from which to apply the settings.",
				"Legt das Exportprofil fest, von welchem die Einstellungen �bernommen werden sollen.");
			...
			builder.AddOrUpdate("Admin.DataExchange.Export.NonFileBasedExport.Note",
				...
				"Der Export-Provider unterst�tzt keinen expliziten Dateityp. F�r eine weitere Bereitstellung der Exportdaten ist daher der Export-Provider verantwortlich.");
			...
			builder.AddOrUpdate("Admin.DataExchange.Export.Projection.NoGroupedProducts",
				...
				"Legt fest, ob Gruppenprodukte exportiert werden sollen. Ist diese Option aktiviert, so werden die zur Gruppe geh�renden Produkte exportiert.");

			builder.AddOrUpdate("Admin.DataExchange.Export.NoFiltering",
				"There is no filtering available.",
				"M�glichkeiten der Filterung stehen nicht zur Verf�gung.");

			builder.AddOrUpdate("Admin.DataExchange.Export.NoProjection",
				"There is no projection available.",
				"M�glichkeiten der Projektion stehen nicht zur Verf�gung.");

			builder.AddOrUpdate("Admin.DataExchange.Export.NoPreview",
				"There is no preview available for this entity type.",
				"Eine Vorschau steht f�r diesen Entit�tstyp nicht zur Verf�gung.");
			...
			builder.AddOrUpdate("StoreClosed.Hint",
				...
				"Wir aktualisieren gerade das Angebot in unserem Online-Shop. Die Seite ist demn�chst wieder verf�gbar.");
			...
			builder.AddOrUpdate("ShoppingCart.ShippingInfoLink",
				...
				"Eine vollst�ndige Liste aller Versandkosten finden Sie <a href=\"{0}\">hier</a>.");
		}
    }
}
