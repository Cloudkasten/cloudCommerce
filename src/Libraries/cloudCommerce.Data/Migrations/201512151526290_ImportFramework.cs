namespace cloudCommerce.Data.Migrations
{
	...
	public partial class ImportFramework : DbMigration, ILocaleResourcesProvider, IDataSeeder<SmartObjectContext>
	{
		...
		public void MigrateLocaleResources(LocaleResourcesBuilder builder)
		{
			...
			builder.AddOrUpdate("Common.Unavailable", "Unavailable", "Nicht verf�gbar");
			...
			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.DataExchange.ImportEntityType.Product", "Product", "Produkt");
			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.DataExchange.ImportEntityType.Customer", "Customer", "Kunde");
			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.DataExchange.ImportEntityType.NewsLetterSubscription", "Newsletter Subscriber", "Newsletter Abonnent");
			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.DataExchange.ImportEntityType.Category", "Category", "Warengruppe");

			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.DataExchange.ImportFileType.CSV", "Delimiter separated values (.csv, .txt, .tab)", "Trennzeichen getrennte Werte (.csv, .txt, .tab)");
			builder.AddOrUpdate("Enums.cloudCommerce.Core.Domain.DataExchange.ImportFileType.XLSX", "Excel (.xlsx)", "Excel  (.xlsx)");
			...
			builder.AddOrUpdate("Admin.DataExchange.ColumnMapping.Note",
				...
				"Sie k�nnen optional f�r jedes Feld der Importdatei festlegen, ob und nach welcher Objekteigenschaft dessen Daten zu importieren sind. Gleichnamige Felder werden grunds�tzlich immer importiert, sofern sie nicht explizit ignoriert werden sollen. Noch nicht ausgew�hlte Eigenschaften sind in der Auswahlliste hervorgehoben. Zudem ist die Angabe eines Standardwertes m�glich, der angewendet wird, wenn das Importfeld leer ist. Durch �nderung des Trennzeichens werden gespeicherte Zuordnungen ung�ltig und zur�ckgesetzt.");
			...
			builder.AddOrUpdate("Admin.Configuration.Settings.GeneralCommon.SeoNameCharConversion",
				...
				"Allows an individual conversion of characters for SEO name creation. Enter the old and the new character separated by a semicolon, e.g. �;ae. Each entry has to be entered in a new line.",
				"Erm�glicht das individuelle Konvertieren von Zeichen bei der Erstellung SEO Namen. Geben Sie hier durch Semikolon getrennt das alte und das neue Zeichen ein, z.B. �;ae. Jeder Eintrag muss in einer neuen Zeile erfolgen.");
			...
			builder.AddOrUpdate("Admin.Configuration.Settings.GeneralCommon.TestSeoNameCreation",
				...
				"Geben Sie eine beliebige Zeichenkette ein, um daraus den SEO Namen zu erstellen. Ge�nderte Einstellungen m�ssen zuvor gespeichert werden.");
			...
			builder.AddOrUpdate("Admin.Configuration.Countries.CannotDeleteDueToAssociatedAddresses",
				...
				"Das Land kann nicht gel�scht werden, weil ihm Adressen zugeordnet sind.");
			...
			builder.AddOrUpdate("Admin.Configuration.Countries.States.CantDeleteWithAddresses",
				...
				"Das Bundesland\\Region kann nicht gel�scht werden, weil ihm Adressen zugeordnet sind.");
			...
			builder.AddOrUpdate("Admin.Configuration.Settings.Order.DisplayOrdersOfAllStores",
				...
				"Legt fest, ob dem Kunden die Auftr�ge aller Shops angezeigt werden sollen. Ist diese Option deaktiviert, so werden nur die Auftr�ge des aktuellen Shops angezeigt.");
			...
			builder.AddOrUpdate("Admin.Configuration.Languages.Fields.FlagImageFileName",
				...
				"Legt das Flaggenbild fest. Die Dateien der Flaggenbilder m�ssen in /Content/Images/flags/ liegen.");
			...
			builder.AddOrUpdate("Admin.Configuration.Settings.Media.MessageProductThumbPictureSize",
				...
				"Thumbnail-Gr��e von Produkten in E-Mails",
				"Specifies the thumbnail image size (pixels) of products in emails. Enter 0 to not display thumbnails.",
				"Legt die Thumbnail-Bildgr��e (in Pixel) von Produkten in E-Mails fest. Geben Sie 0 ein, um keine Thumbnails anzuzeigen.");
			...
			builder.AddOrUpdate("Providers.ExchangeRate.EcbExchange.SetCurrencyToEURO",
				...
				"Der EZB-Wechselkursdienst kann nur genutzt werden, wenn der Wechselkurs-W�hrungscode auf EUR gesetzt ist.");


			builder.AddOrUpdate("Common.Loading", "Loading", "Lade");
			builder.AddOrUpdate("Common.ShowMore", "Show more", "Mehr anzeigen");
			builder.AddOrUpdate("Common.Published", "Published", "Ver�ffentlicht");
			builder.AddOrUpdate("Common.Unpublished", "Unpublished", "Unver�ffentlicht");
			builder.AddOrUpdate("Common.NotSelectable", "Not selectable", "Nicht ausw�hlbar");

			builder.AddOrUpdate("Common.EntityPicker.SinglePickNote",
				"Click on an item to select it and OK to apply it.",
				"Klicken Sie auf ein Element, um es auszuw�hlen und OK, um es zu �bernehmen.");
			...
			builder.AddOrUpdate("Common.EntityPicker.MultiPickNote",
				...
				"Klicken Sie auf ein Element, um es aus- bzw. abzuw�hlen und OK, um die Auswahl zu �bernehmen.");
			...
			builder.AddOrUpdate("Admin.Catalog.Products.RelatedProducts.AddNew",
				...
				"Cross-Selling-Produkt hinzuf�gen");
			...
			builder.AddOrUpdate("Admin.Catalog.Products.RelatedProducts.SaveBeforeEdit",
				...
				"Sie m�ssen das Produkt speichern, bevor Sie Cross-Selling-Produkte hinzuf�gen k�nnen.");

			builder.AddOrUpdate("Admin.Catalog.Products.CrossSells.AddNew",
				"Add checkout-selling product",
				"Checkout-Selling-Produkt hinzuf�gen");
			...
			builder.AddOrUpdate("Admin.Catalog.Products.CrossSells.SaveBeforeEdit",
				...
				"Sie m�ssen das Produkt speichern, bevor Sie Checkout-Selling-Produkte hinzuf�gen k�nnen.");
		}
	}
}
