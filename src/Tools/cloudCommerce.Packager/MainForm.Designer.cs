namespace cloudCommerce.Packager
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.txtRootPath.Text = "D:\\Git\\cloudCommerceNETFull\\cloudCommerceNET\\build\\Web";
			// 
			// txtOutputPath
			// 
			...
			this.txtOutputPath.Text = "D:\\Git\\cloudCommerceNETFull\\cloudCommerceNET\\build\\Packages";
			// 
			// lblRootPath
			// 
    ...
    " folders.";
			...
			this.Name = "MainForm";
			this.Text = " cloudCommerce.NET Extension Packager";
