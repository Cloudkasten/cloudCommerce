...
using cloudCommerce.AmazonPay.Controllers;
...
namespace cloudCommerce.AmazonPay
{
	...
	public class Plugin : PaymentPluginBase, IConfigurable
	{
		...
		public override void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
		{
			...
			routeValues = new RouteValueDictionary() { { "Namespaces", "cloudCommerce.AmazonPay.Controllers" }, { "area", AmazonPayCore.SystemName } };
		}
