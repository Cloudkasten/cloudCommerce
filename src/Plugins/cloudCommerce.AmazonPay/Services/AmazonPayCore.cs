...
namespace cloudCommerce.AmazonPay.Services
{
	public static class AmazonPayCore
	{
		...
		public static string AppName { get { return "cloudCommerce.Net " + SystemName; } }
		public static string SystemName { get { return "cloudCommerce.AmazonPay"; } }
		...
		public static string DataPollingTaskType { get { return "cloudCommerce.AmazonPay.DataPollingTask, cloudCommerce.AmazonPay"; } }
