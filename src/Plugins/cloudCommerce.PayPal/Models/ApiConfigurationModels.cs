...
namespace cloudCommerce.PayPal.Models
{
	public abstract class ApiConfigurationModel: ModelBase
	{
		...
		[SmartResourceDisplayName("Plugins.cloudCommerce.PayPal.ClientId")]
		public string ClientId { get; set; }

		[SmartResourceDisplayName("Plugins.cloudCommerce.PayPal.Secret")]
		public string Secret { get; set; }

		[SmartResourceDisplayName("Plugins.cloudCommerce.PayPal.ExperienceProfileId")]
		public string ExperienceProfileId { get; set; }

		[SmartResourceDisplayName("Plugins.cloudCommerce.PayPal.WebhookId")]
