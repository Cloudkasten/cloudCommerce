...
using cloudCommerce.PayPal.PayPalSvc;
    ...
    public partial class PayPalExpressProvider : PayPalProviderBase<PayPalExpressPaymentSettings>
    {
        ...
        public SetExpressCheckoutResponseType SetExpressCheckout(PayPalProcessPaymentRequest processPaymentRequest, IList<OrganizedShoppingCartItem> cart)
        {
            ...
            var details = new SetExpressCheckoutRequestDetailsType
            {
                ...
                ReturnURL = Services.WebHelper.GetStoreLocation(store.SslEnabled) + "Plugins/cloudCommerce.PayPal/PayPalExpress/GetDetails",
                //CallbackURL = _webHelper.GetStoreLocation(currentStore.SslEnabled) + "Plugins/cloudCommerce.PayPal/PayPalExpress/ShippingOptions?CustomerID=" + _workContext.CurrentCustomer.Id.ToString(),
            ...
            var paymentDetails = new PaymentDetailsType
            {
                ...
                ButtonSource = cloudCommerceVersion.CurrentFullVersion,
                PaymentAction = GetPaymentAction(settings),
