...
using cloudCommerce.DiscountRules.Models;
...
namespace cloudCommerce.DiscountRules.Controllers
{
    ...
    public class DiscountRulesController : PluginControllerBase
    {
		...
		private ActionResult HandleGet<TModel>(int discountId, int? discountRequirementId, string prefix, Func<DiscountRequirement, TModel> modelCreator) where TModel : DiscountRuleModelBase
		{
			...
			if (discount == null)
				throw new ArgumentException(T("Plugins.cloudCommerce.DiscountRules.ConfigureDiscountNotLoaded"));
			...
			if (discountRequirementId.HasValue)
			{
				...
				if (discountRequirement == null)
					return Content(T("Plugins.cloudCommerce.DiscountRules.ConfigureRequirementFailed"));
			}
