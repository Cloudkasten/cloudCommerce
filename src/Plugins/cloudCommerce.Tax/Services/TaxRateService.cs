...
namespace cloudCommerce.Tax.Services
{
    /// <summary>
    /// Tax rate service
    /// </summary>
    ...
    {
        #region Constants
        private const string TAXRATE_ALL_KEY = "cloudCommerce.taxrate.all";
        private const string TAXRATE_BY_ID_KEY = "cloudCommerce.taxrate.id-{0}";
        private const string TAXRATE_PATTERN_KEY = "cloudCommerce.taxrate.";
        #endregion
