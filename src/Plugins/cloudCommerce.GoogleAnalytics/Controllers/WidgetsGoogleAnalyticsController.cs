...
using cloudCommerce.GoogleAnalytics.Models;
...
namespace cloudCommerce.GoogleAnalytics.Controllers
{
    ...
    public class WidgetsGoogleAnalyticsController : SmartController
    {
        ...
        public ActionResult PublicInfo(string widgetZone)
        {
            ...
            {
                Logger.InsertLog(cloudCommerce.Core.Domain.Logging.LogLevel.Error, "Error creating scripts for google ecommerce tracking", ex.ToString());
            }
