...
namespace cloudCommerce.GoogleMerchantCenter.Providers
{
	...
	public class GmcXmlExportProvider : ExportProviderBase
	{
		...
		public override ExportConfigurationInfo ConfigurationInfo
		{
			get
			{
				...
				{
					PartialViewName = "~/Plugins/cloudCommerce.GoogleMerchantCenter/Views/FeedGoogleMerchantCenter/ProfileConfiguration.cshtml",
