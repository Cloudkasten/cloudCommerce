...
using cloudCommerce.OfflinePayment.Validators;
...
namespace cloudCommerce.OfflinePayment.Controllers
{
    ...
    public class OfflinePaymentController : PaymentControllerBase
    {
		...
		private List<SelectListItem> GetTransactModes()
		{
			...
			{
				new SelectListItem { Text = T("Enums.cloudCommerce.Core.Domain.Payments.PaymentStatus.Pending"), Value = ((int)TransactMode.Pending).ToString() },
				new SelectListItem { Text = T("Enums.cloudCommerce.Core.Domain.Payments.PaymentStatus.Authorized"), Value = ((int)TransactMode.Authorize).ToString() },
				new SelectListItem { Text = T("Enums.cloudCommerce.Core.Domain.Payments.PaymentStatus.Paid"), Value = ((int)TransactMode.Paid).ToString() }
			};
