...
namespace cloudCommerce.Data.Tests
{
	...
	public class GlobalSetup
	{
		...
		{
			string testDbName = "Data Source=" + (System.IO.Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().Location)) + @"\cloudCommerce.Data.Tests.Db.sdf;Persist Security Info=False";
			return testDbName;
		}  
	}
}
