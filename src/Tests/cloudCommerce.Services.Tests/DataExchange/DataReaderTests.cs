...
namespace cloudCommerce.Services.Tests.DataExchange
{
	...
	public class DataReaderTests
	{
		...
		{
			return typeof(DataReaderTests).Assembly.GetManifestResourceStream("cloudCommerce.Services.Tests.DataExchange.Files.{0}".FormatInvariant(fileName));
		}
