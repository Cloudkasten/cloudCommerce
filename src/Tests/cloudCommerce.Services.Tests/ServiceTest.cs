...
using cloudCommerce.Services.Tests.Directory;
using cloudCommerce.Services.Tests.Discounts;
using cloudCommerce.Services.Tests.Payments;
using cloudCommerce.Services.Tests.Shipping;
using cloudCommerce.Services.Tests.Tax;
using NUnit.Framework;
using Rhino.Mocks;

namespace cloudCommerce.Services.Tests
{
    [TestFixture]
