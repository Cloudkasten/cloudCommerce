...
* (Dev) Publishing cloudCommerce.Web from within Visual Studio now deploys the project correctly. No need to execute ClickToBuild.cmd anymore. Just publish directly to any target, including Azure.
...
* #749 Visual Studio 2015 compilation error: CS0009: Metadata file. cloudCommerce.Licensing.dll could not be opened -- Illegal tables in compressed metadata stream
...
## cloudCommerce.NET 2.2.2

### New Features
* cloudCommerce.NET User Guide
...
* (Developer) Moved _PublicControllerBase_ to cloudCommerce.Web.Framework
* (Developer) Moved 'AdminControllerBase' to cloudCommerce.Web.Framework
...
## cloudCommerce.NET 1.2.0.0

### Highlights
 - Multi-store support
 - "Trusted Shops" plugins
 - Highly improved _cloudCommerce.biz Importer_ plugin
...
### New Features
 ...
 - (Developer) Added new plugin __Glimpse for cloudCommerce.NET__
...
### Bugfixes
 - bunch of fixes and improvements for the _cloudCommerce.biz Importer_ plugin
